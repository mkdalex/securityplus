const Q_D4 = [
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A security engineer is testing a new web application by sending large amounts of random, malformed data into the input fields to see if the application crashes or reveals errors. Which technique is this?",
  "opts": [
   "A. Static Analysis",
   "B. Fuzzing",
   "C. Code Review",
  ...
  "correct": 1,
  "exp": "Fuzzing (fuzz testing) is an automated software testing technique that involves providing invalid, unexpected, or random data as inputs to a computer program to find bugs and security vulnerabilities."
 },
 {
  "id": 330,
  "obj": "4.8",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "An analyst needs to query a DNS server to retrieve the Mail Exchanger (MX) records for a specific domain. Which command-line tool is best suited for this on a Linux system?",
  "opts": [
   "A. netstat",
   "B. dig",
   "C. route",
  ...
  "correct": 1,
  "exp": "'dig' (Domain Information Groper) is a flexible tool for interrogating DNS name servers. It can specifically query for MX, A, AAAA, and TXT records."
 },
 {
  "id": 366,
  "obj": "4.1",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A user authenticates using a code generated by a hardware token that changes every 30 seconds. Which type of MFA factor is this?",
  "opts": [
  ...
  "correct": 1,
  "exp": "TOTP is a type of one-time password that uses the current time as a source of uniqueness. It is the basis for most authenticator apps."
 },
 {
  "id": 375,
  "obj": "4.3",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A security analyst is overwhelmed by an IDS that flags legitimate corporate VPN traffic as a 'Suspicious Tunneling Attempt.' What is the analyst experiencing?",
  "opts": [
   "A. False Negative",
   "B. False Positive",
   "C. True Negative",
  ...
  "correct": 1,
  "exp": "A False Positive is an alert that incorrectly identifies legitimate activity as malicious. This causes alert fatigue and masks real threats."
 },
 {
  "id": 402,
  "obj": "4.5",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "An administrator needs to determine the path that packets take to reach a remote server and identify which intermediate router is dropping traffic. Which tool should they use?",
  "opts": [
   "A. ping",
  ...
  "correct": 1,
  "exp": "Tracert (Windows) or Traceroute (Linux) shows the hop-by-hop path to a destination and the latency at each stop, helping identify network bottlenecks or failures."
 },
 {
  "id": 404,
  "obj": "4.2",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "An analyst notices a SIEM rule is triggering alerts every time a specific server performs its nightly backup. Which action should the analyst take to improve the system?",
  "opts": [
   "A. Delete the rule",
   "B. Increase the alert priority",
   "C. Tune the rule by adding an exception for the backup window",
   "D. Disable logging on the server"
  ],
  "correct": 2,
  "exp": "Tuning SIEM rules involves refining them to reduce false positives (noise) caused by known, legitimate activities."
 },
 {
  "id": 442,
  "obj": "4.5",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "Following the Order of Volatility, which of the following is most likely to be lost first if a system is powered off?",
  "opts": [
   "A. RAM",
   "B. SSD data",
   "C. CPU Cache",
  ...
  "correct": 2,
  "exp": "CPU Cache and registers are the most volatile (lost in nanoseconds), followed by RAM, then disk data."
 },
 {
  "id": 443,
  "obj": "4.1",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A development team uses a tool that scans their code for vulnerabilities while they are writing it, before the code is even compiled. What is this?",
  "opts": [
   "A. DAST",
   "B. SAST",
   "C. Penetration Test",
  ...
  "correct": 1,
  "exp": "SAST (Static Analysis) analyzes source code at rest. It is a 'shift-left' technique used early in the SDLC."
 },
 {
  "id": 445,
  "obj": "4.6",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "Which document defines the specific boundaries, timeframes, and banned tools for a penetration testing team?",
  "opts": [
   "A. SLA",
   "B. Rules of Engagement (RoE)",
   "C. NDA",
  ...
  "correct": 1,
  "exp": "The RoE specifies how the test is conducted to ensure no accidental damage occurs and that the test remains legal and in-scope."
 },
 {
  "id": 446,
  "obj": "4.7",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A domain owner wants to ensure that any emails failing SPF/DKIM checks are never delivered to the recipient's inbox. Which DMARC policy should they use?",
  "opts": [
   "A. p=none",
   "B. p=quarantine",
   "C. p=reject",
  ...
  "correct": 2,
  "exp": "'p=reject' instructs receiving servers to drop emails that fail authentication entirely."
 },
 {
  "id": 447,
  "obj": "4.8",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A security engineer needs to write a script to interact with a cloud provider's API to rotate secrets. Which language is the MOST common choice for this?",
  "opts": [
   "A. C++",
   "B. Python",
   "C. HTML",
  ...
  "correct": 1,
  "exp": "Python is the primary language for security automation and cloud scripting due to its extensive API libraries."
 },
 {
  "id": 449,
  "obj": "4.3",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "Which technology allows a SOC to automate an entire incident response workflow, from blocking an IP to notifying a manager?",
  "opts": [
   "A. SIEM",
   "B. SOAR",
   "C. IPS",
  ...
  "correct": 1,
  "exp": "SOAR (Security Orchestration, Automation, and Response) uses 'playbooks' to orchestrate actions across different security tools."
 },
 {
  "id": 450,
  "obj": "4.1",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "In an OIDC (OpenID Connect) authentication flow, what is the server that maintains the user's identity called?",
  "opts": [
   "A. Service Provider",
   "B. Identity Provider (IdP)",
   "C. Relying Party",
  ...
  "correct": 1,
  "exp": "The IdP (like Google, Okta, or Azure AD) is the central authority that authenticates the user and issues tokens."
 },
 {
  "id": 491,
  "obj": "4.3",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "A SIEM system collects logs from a Windows server and a Linux firewall. The logs use different date formats. The SIEM converts them into a single, unified format for analysis. What is this process?",
  "opts": [
   "A. Aggregation",
   "B. Normalization",
   "C. Compression",
  ...
  "correct": 1,
  "exp": "Normalization is the process of mapping diverse log formats into a common schema for correlation."
 },
 {
  "id": 492,
  "obj": "4.5",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "Which forensic tool is specifically used to prevent any data from being written to a suspect drive while creating an image of its contents?",
  "opts": [
   "A. Hashing tool",
   "B. Write Blocker",
   "C. Packet Sniffer",
  ...
  "correct": 1,
  "exp": "A write blocker allows read access but blocks all write signals, ensuring the original evidence remains pristine."
 },
 {
  "id": 493,
  "obj": "4.2",
 ...
 },
 {
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "When an evidence drive is moved from the evidence locker to the analysis lab, the investigator and the lab technician both sign a log. What is this process?",
  "opts": [
   "A. Non-repudiation",
   "B. Chain of Custody",
  ...
  "correct": 1,
  "exp": "Chain of custody is the documentation tracking who handled the evidence, when, and where."
 },
 {
  "id": 497,
  "obj": "4.7",
  ...
  "badge": "Multiple Choice",
  "badgeClass": "mcq-b",
  "stem": "Which DMARC setting ensures that any email failing alignment checks is completely discarded and never reaches the user's inbox or spam folder?",
  "opts": [
   "A. p=none",
   "B. p=quarantine",
   "C. p=reject",
  ...
  "correct": 2,
  "exp": "'p=reject' instructs the receiving mail server to outright reject the email."
 },
 {
  "id": 498,
  "obj": "4.2",
